# Seasons and the Moon Activities

## Seasons Lecture Tutorial

Seasons pages 103-108  

Note: The Earth is about 6000 km across (0.006 million km).
...
- [x] When it is summer, the Sun is giving off more energy and when it is winter the Sun is giving off less energy.
- [x] When it is summer, more sunlight reaches Earth as a whole than it does during the winter. 
- [x] Our location on Earth (Fullerton) is closer to the Sun in summer than it is in winter.

When it is summer in the Northern Hemisphere, it is winter in the Southern Hemisphere. If something about the Sun and Earth as a whole was responsible, both hemispheres would experience summer at the same time.

Earth's orbit takes us 5 million km closer to the Sun in December than we are in June, a much bigger change than the distance across Earth.



</quiz>

![All Earths have their north pole tilted to the left. A: to the left of the sun, observer in the shadow and above the equator. B: to the right of the sun, observer in the shadow and above the equator. C: to the left of the sun, observer in the shadow and below the equator. D: to the right of the sun, observer in the daylight and below the equator. E: to the left of the sun, observer in the daylight and above the equator. F: to the right of the sun, observer in the daylight and above the equator. Remember: all Earths tilt left.](img/seasonal-observers.png)
<quiz>

Which of the lettered observers in the image above are experiencing summer?
...
Summer is whenever the hemisphere is tilted toward the sun.

<quiz>
If Earth were tilted more (60 degrees rather than 23.5 degrees), then during winter at your location you would: 

- [x]  experience cooler temperatures. 
- [ ] experience warmer temperatures. 
- [ ]  not experience any significant change in temperature. 
...
how much of the Moon’s **total** surface 
...
how much of the Moon’s **visible** surface 
is being illuminated by sunlight?
...
<quiz>
The diagram below illustrates the geometry of 
lunar phases with the moon shown in 
...
![eight moon positions around the Earth, with sunlight coming from the top. From Earth, (A) diagonal upper left. (B) diagonal upper right. (C) is diagonal lower left. (D) is diagonal lower right.](../img/moon-positions-3.png)

Which position corresponds to a waning gibbous moon?
- [ ]  (A)
- [ ] (B)
- [ ] (C)
- [x] (D)
