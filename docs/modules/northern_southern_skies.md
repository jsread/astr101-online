...
We'll discuss skies in the Northern and Southern hemispheres, and the change in sky motion with latitude.
...
Think back to our [Celestial Sphere Model](celestial_sphere.md).
...
At a given latitude, you can have a mixture of [types of star](daily_motion_sky.md#types-of-stars):
