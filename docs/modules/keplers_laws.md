...
![A planet moves around the sun on an elliptic orbit. A and B are two locations farther from the Sun, close to aphelion, making a longer skinnier triangle-like shape. C and D are on either side of Perihelion, making a broader wedge. ](img/kepler-second-diagram.png)

These three regions have close to equal area:
![A broad wedge A around perihelion, a narrower wedge B to the top right, a very narrow wedge C around aphelion.](img/three-orbit-regions.png)

### Comparing areas

It takes practice to compare areas of different shapes. Equal area:

![Boxes fill up a narrow wege to aphelion on the left.](img/left-area.png)

![The same boxes fill up a wider wedge to perihelion on the right.](img/right-area.png)

<summary> The areas are ... 
<details> The same. </details>
</summary>

<summary> The time taken for each segment is ... 
<details> The same. </details>
</summary>
...
<summary> Which planet is moving faster?
<details> Planet B</details>
</summary>

So for our left and right segments with equal area, 
<summary> which is faster?
<details> The one with a longer path, on the right. </details>
</summary>
...
![A circle with the radius from the center to one side labeled a.](img/semi-major-circle.png){height="100"} 

![An ellipse with the distance frome the center to the widest part labeled a.](img/semi-major-ellipse.png){height="100"} 
...
![A orbits from 2AU on the left to 1AU on the right. B orbits from 6 AU on the top to 2 AU on the bottom. C orbits from 1 AU on the left to 5 AU on the right. D orbits from 1 AU on the top to 6 AU on the bottom. ](img/different-orbits.png)
