...
![Earth orbits the sun, shown at opposite sides in June and December. Lines from each position cross at a nearby star and extend out.](img/stellar-parallax.jpg)
...
![A narrow triangle with the parallax angle at a sharp point. It length is labeled 2 million light minutes, and its height is labeled 8 light minutes
](img/nearest-star-parallax.png)
...
![A large circle labeled “1 circle = 360 degrees,” followed by zoomed-in sections showing “1 degree = 60 arcminutes” and “1 arcminute = 60 arcseconds.”
](img/degrees-to-arcseconds.png)
...
![A Sun-Earth orbit diagram labeled “1 A.U.”, with sight lines extending to a distant object to show that 1 parsec corresponds to a parallax angle of 1 arcsecond.
](img/parsec.png)
...
![47 AU from Earth to New Horizons. Lines from each cross at a nearby star, and extend to distant background stars. The apparent positions of the star as seen by New Horizons and Earth are shown there.](img/new-horizons-parallax.png)
 
![Proxima Centauri from Earth and from New Horizons, moving against background stars](img/nh-proxima_cap-2.gif)
