...
![A corroded fragment of metal machinery, showing a circle with crossbars and many knobs and holes.](img/Antikythera_Fragment_A_(Front).webp.png)

This is copy of Aristarchus’s calculation  of the size of the Sun, Earth, and Moon in 3 BC.
![Ink writing over a geometrical figure showing a large circle, second smaller circle, and offset third smallest circle, with lines connecting centers and edges and greek letters marking various intersections](img/Aristarchus_working.jpg)
...
![The sun reflecting off water at the center of a deep cylindrical well.](img/The_Well_at_Kom_Ombo.jpg)

In Alexandria, at the Solstice, tall objects still cast shadows in sun.
![Arrows representing sunlight slant down on a Sphinx and a tall column emphasizing the direction of light and shadow.](img/alexandria-photo.jpg)

The difference came from their different locations on Earth.
![A map showing Alexandria, close to Nile Delta on the Mediterranian ocean, and Syene, a distance marked 5000 Stadia away down far along the Nile.](img/Alexandria-Syene-map.png)
...
![Parallel rays of sunlight come in from the upper right, and align with the well. The column is tilted compared to the well because of its location on Earth. The shadow from the column is used to measure the 7 degree angle of tilt. This matches the angle from the Earth's center between the column and the well, also 7 degrees. A green line marks the distance between the column and the well](img/sunlight-alexandria-syene.png)
...
![Ptolmey holding a celestial sphere model showing the earth and the ecliptic in a wire sphere around it.](img/Ptolemy_1476_with_armillary_sphere_model.jpg)
...
![Earth is shown surrounded by spheres for the moon, planets, and sun.](img/Bartolomeu_Velho_1568.jpg)
...
![A diagram of Ptolmey's model as described below.](img/Ptolemaic_Model.png) [Source: Wikipedia](https://commons.wikimedia.org/wiki/File:Ptolemaic_Model.png)
...
![Animation of an epicycle. ](https://upload.wikimedia.org/wikipedia/commons/c/c6/Epicycles.gif)
